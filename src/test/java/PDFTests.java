...
public class PDFTests extends BaseTests {
    ...
    public void testInvoices() throws IOException, InterruptedException {
        ...
        generatorPage.setLogo(new File("src/test/resources/logo.png"));
        ...
        File downloadedPDF = new File("C:\\Users\\BillGates\\Downloads\\" + invoiceNumber + ".pdf");
        String destination = "src/test/resources/Invoice_PDFs/" + invoiceNumber + ".pdf";
        System.out.println(downloadedPDF);
